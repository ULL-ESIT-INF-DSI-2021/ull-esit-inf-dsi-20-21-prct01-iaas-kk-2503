...
![Contraseña actual](img/6.png)

![Contraseña nueva](img/7.png)

![Sesión iniciada](img/8.png)
...
![Contenido anterior](img/17.png)

Contenido actual:

![Contenido actual](img/18.png)
...
![ssh simplificado](img/49.png)

![conectado](img/50.png)
...
![comprobar modificacion](img/58.png)
...
![crear git prompt](img/59.png)

![poner contenido](img/60.png)
...
![cambiar nombre](img/62.png)

![poner contenido](img/63.png)

Después ejecutamos *exec bash -l*

![exec bash](img/64.png)
...
![usar version](img/85.png)

![comprobar version](img/86.png)
